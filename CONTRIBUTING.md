...
1. **Branch for everything.** `feat/<slice>`, `fix/<thing>`, `docs/<area>`, `chore/<task>`. No direct pushes to `main` (force-push and deletion are blocked; history must stay linear).
